        ...
        >
            {navigation.map(({ label, path, icon, active }, index) => (
                ...
                >
                    <motion.p
                        className={cn(
                            "hover:text-indigo-500 flex justify-start items-center z-10 gap-[14px] font-dm-sans text-sm font-bold leading-tight px-[18px] py-3 transition-colors duration-150",
